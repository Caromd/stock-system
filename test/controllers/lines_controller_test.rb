...
class LinesControllerTest < ActionController::TestCase
  ...
  test "should create line" do
    assert_difference('Line.count') do
      post :create, line: { comment: @line.comment, document_id: @line.document_id, item_id: @line.item_id, qtynew: @line.qtynew, qtyused: @line.qtyused }
    end
  ...
  test "should update line" do
    patch :update, id: @line, line: { comment: @line.comment, document_id: @line.document_id, item_id: @line.item_id, qtynew: @line.qtynew, qtyused: @line.qtyused }
    assert_redirected_to line_path(assigns(:line))
  end
